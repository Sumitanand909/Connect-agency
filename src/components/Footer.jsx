  ...
  return (
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        ...
        <div className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
            <p>Copyright 2025 &copy; <a href="https://github.com/Sumitanand909"><span>Sumit@dev</span></a> - All Right Reserved.</p>
            <div className='flex items-center justify-between gap-4'>
                <a href="https://x.com/Sumitan_909">
                    <img src={assets.twitter_icon} alt="" />
                </a>
                <a href="https://www.instagram.com/__sumit.909?igsh=MTZjNmlvaDR6NGZ5aw==">
                    <img src={assets.instagram_icon} alt="" />
                </a>
                <a href="https://linkedin.com/in/sumitanandofficial">
