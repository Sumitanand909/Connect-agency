...
const ContactUs = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "18f18f4b-3427-4626-8292-1b433412af54");
        ...
        try {
            ...
            if (data.success) {
                toast.success('Thankyou for your submition!');
                event.target.reset();
            } else {
    ...
    return (
        <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
            ...
            <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
                <div>
                    <p className='mb-2 text-sm font-meduim'>Your name</p>
                ...
                <div>
                    <p className='mb-2 text-sm font-meduim'>Your email</p>
                    <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                ...
                <div className='sm:col-span-2'>
                    <p className='mb-2 text-sm font-meduim'>Message</p>
